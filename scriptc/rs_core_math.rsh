 ...
 * Supported by API versions 9 and newer.
 */
extern float __attribute__((const, overloadable))fract(float v, float *floor);
#endif
 ...
 * Supported by API versions 9 and newer.
 */
extern float2 __attribute__((const, overloadable))fract(float2 v, float2 *floor);
#endif
 ...
 * Supported by API versions 9 and newer.
 */
extern float3 __attribute__((const, overloadable))fract(float3 v, float3 *floor);
#endif
 ...
 * Supported by API versions 9 and newer.
 */
extern float4 __attribute__((const, overloadable))fract(float4 v, float4 *floor);
#endif
 ...
 * Supported by API versions 9 and newer.
 */
extern float __attribute__((const, overloadable))remquo(float b, float c, int *d);
#endif
 ...
 * Supported by API versions 9 and newer.
 */
extern float2 __attribute__((const, overloadable))remquo(float2 b, float2 c, int2 *d);
#endif
 ...
 * Supported by API versions 9 and newer.
 */
extern float3 __attribute__((const, overloadable))remquo(float3 b, float3 c, int3 *d);
#endif
 ...
 * Supported by API versions 9 and newer.
 */
extern float4 __attribute__((const, overloadable))remquo(float4 b, float4 c, int4 *d);
#endif
