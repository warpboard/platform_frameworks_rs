...
.equ cospi_1_64  ,  16364
.equ cospi_2_64  ,  16305
.equ cospi_3_64  ,  16207
.equ cospi_4_64  ,  16069
.equ cospi_5_64  ,  15893
.equ cospi_6_64  ,  15679
.equ cospi_7_64  ,  15426
.equ cospi_8_64  ,  15137
.equ cospi_9_64  ,  14811
.equ cospi_10_64 ,  14449
.equ cospi_11_64 ,  14053
.equ cospi_12_64 ,  13623
.equ cospi_13_64 ,  13160
.equ cospi_14_64 ,  12665
.equ cospi_15_64 ,  12140
.equ cospi_16_64 ,  11585
.equ cospi_17_64 ,  11003
.equ cospi_18_64 ,  10394
.equ cospi_19_64 ,   9760
.equ cospi_20_64 ,   9102
.equ cospi_21_64 ,   8423
.equ cospi_22_64 ,   7723
.equ cospi_23_64 ,   7005
.equ cospi_24_64 ,   6270
.equ cospi_25_64 ,   5520
.equ cospi_26_64 ,   4756
.equ cospi_27_64 ,   3981
.equ cospi_28_64 ,   3196
.equ cospi_29_64 ,   2404
.equ cospi_30_64 ,   1606
.equ cospi_31_64 ,    804


    .global vp9_idct32x32_1024_add_neon
	.type vp9_idct32x32_1024_add_neon, function
   .arm
...
.macro    LOAD_FROM_TRANSPOSED prev_offset, first_offset, second_offset
    ...
    @   use.
.macro    LOAD_FROM_OUTPUT prev_offset, first_offset, second_offset, reg1, reg2
    @ address calculation with proper stride and loading
    ...
    @   output, wethere reading or storing) must be passed in. use 0 for first
    @   use.
.macro    STORE_IN_OUTPUT prev_offset, first_offset, second_offset, reg1, reg2
...
.macro    STORE_COMBINE_CENTER_RESULTS
    ...
    @ Combine-add results with current destination content
    @   q6-q9 contain the results (out[j * 32 + 0-31])
.macro    STORE_COMBINE_CENTER_RESULTS_LAST
    @ load dest[j * dest_stride + 0-31]
    vld1.s16        {d8}, [r10], r2
    vld1.s16        {d11}, [r9], r11
    vld1.s16        {d9}, [r10]
...
.macro    STORE_COMBINE_EXTREME_RESULTS
    @ load dest[j * dest_stride + 0-31]
    vld1.s16        {d4}, [r7], r2
    vld1.s16        {d7}, [r6], r11
    vld1.s16        {d5}, [r7]
    ...
    @ Combine-add results with current destination content
    @   q4-q7 contain the results (out[j * 32 + 0-31])
.macro    STORE_COMBINE_EXTREME_RESULTS_LAST
    @ load dest[j * dest_stride + 0-31]
    vld1.s16        {d4}, [r7], r2
    vld1.s16        {d7}, [r6], r11
    vld1.s16        {d5}, [r7]
...
.macro    DO_BUTTERFLY regC, regD, regA, regB, first_constant, second_constant, reg1, reg2, reg3, reg4
    ...
    @ Touches q8-q12, q15 (q13-q14 are preserved)
    @ valid output registers are anything but q8-q11
.macro    DO_BUTTERFLY_STD first_constant, second_constant, reg1, reg2, reg3, reg4
...
idct32_bands_end_2nd_pass:
    ...
    pop  {r4-r11}
    bx              lr
	.size vp9_idct32x32_1024_add_neon, .-vp9_idct32x32_1024_add_neon    @ ENDP  @ |vp9_idct32x32_1024_add_neon|
