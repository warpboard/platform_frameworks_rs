...
#define rsIntra_pred_sized(type, b_size) \
    extern void rsIntra_predict_##type##_predictor_##b_size##x##b_size( \
...
#define rsIntra_pred_allsizes(type) \
    rsIntra_pred_sized(type, 4) \
    rsIntra_pred_sized(type, 8) \
    rsIntra_pred_sized(type, 16) \
    rsIntra_pred_sized(type, 32)
...
rsIntra_pred_allsizes(dc_128)

#undef rsIntra_pred_allsizes
