...
void rsdIntrinsicBlendSrcAtop_K(void *dst, const void *src, uint32_t count8) {
    ...
    for (i = 0; i < count8; ++i) {
        ...
        outa = _mm_shufflelo_epi16(outs, 0xFF);
        outa = _mm_shufflehi_epi16(outa, 0xFF);
        t0 = _mm_mullo_epi16(_mm_sub_epi16(all1s, ina), outs);
        ...
        outa = _mm_shufflelo_epi16(outs, 0xFF);
        outa = _mm_shufflehi_epi16(outa, 0xFF);
        t1 = _mm_mullo_epi16(_mm_sub_epi16(all1s, ina), outs);
        ...
        outa = _mm_shufflelo_epi16(outs, 0xFF);
        outa = _mm_shufflehi_epi16(outa, 0xFF);
        t2 = _mm_mullo_epi16(_mm_sub_epi16(all1s, ina), outs);
        ...
        outa = _mm_shufflelo_epi16(outs, 0xFF);
        outa = _mm_shufflehi_epi16(outa, 0xFF);
        t3 = _mm_mullo_epi16(_mm_sub_epi16(all1s, ina), outs);
...
void rsdIntrinsicBlendDstAtop_K(void *dst, const void *src, uint32_t count8) {
    ...
    for (i = 0; i < count8; ++i) {
        ...
        outa = _mm_shufflelo_epi16(outs, 0xFF);
        outa = _mm_shufflehi_epi16(outa, 0xFF);
        t0 = _mm_mullo_epi16(_mm_sub_epi16(all1s, outa), outs);
        ...
        outa = _mm_shufflelo_epi16(outs, 0xFF);
        outa = _mm_shufflehi_epi16(outa, 0xFF);
        t1 = _mm_mullo_epi16(_mm_sub_epi16(all1s, outa), outs);
        ...
        outa = _mm_shufflelo_epi16(outs, 0xFF);
        outa = _mm_shufflehi_epi16(outa, 0xFF);
        t2 = _mm_mullo_epi16(_mm_sub_epi16(all1s, outa), outs);
        ...
        outa = _mm_shufflelo_epi16(outs, 0xFF);
        outa = _mm_shufflehi_epi16(outa, 0xFF);
        t3 = _mm_mullo_epi16(_mm_sub_epi16(all1s, outa), outs);
